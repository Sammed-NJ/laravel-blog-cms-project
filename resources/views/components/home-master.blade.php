        ...
        <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    @if (Auth::check())
                        <li class="dropdown"><a href="category.html"><span>Sammed nj </span><i
                                    class="bi bi-chevron-down dropdown-indicator"></i></a>
                            <ul>
                                <li><a href="/admin">Manage Account</a></li>
                                <li><a href="#">Write a Blog</a></li>
                                <li><a href="/">Log out</a></li>
                            </ul>
                        </li>
                    @else
                        <li><a href="/login">Login to Post</a></li>
                    @endif
                        ...
                        <ul class="footer-links footer-blog-entry list-unstyled">
                            <li>
                                <a href="single-post.html" class="d-flex align-items-center">
                                    <img src="{{ asset('/images/post-sq-1.jpg') }}" alt=""
                            ...
                            <li>
                                <a href="single-post.html" class="d-flex align-items-center">
                                    <img src="{{ asset('/images/post-sq-2.jpg') }}" alt=""
                                        class="img-fluid me-3">
                                    <div>
                                        <div class="post-meta d-block"><span class="date">Culture</span> <span
                                                class="mx-1">&bullet;</span>
                            ...
                            <li>
                                <a href="single-post.html" class="d-flex align-items-center">
                                    <img src="{{ asset('/images/post-sq-3.jpg') }}" alt=""
                                        class="img-fluid me-3">
                                    <div>
                                        <div class="post-meta d-block"><span class="date">Culture</span> <span
                                                class="mx-1">&bullet;</span>
                            ...
                            <li>
                                <a href="single-post.html" class="d-flex align-items-center">
                                    <img src="{{ asset('/images/post-sq-4.jpg') }}" alt=""
                                        class="img-fluid me-3">
                                    <div>
                                        <div class="post-meta d-block"><span class="date">Culture</span> <span
                                                class="mx-1">&bullet;</span>
